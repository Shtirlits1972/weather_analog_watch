...
const String dbName = 'w_5.db';
const String title = 'weather & clock';
const Apptitle = 'w_5';

const appid = '843cac307e362a6ce69b47e9edbfc851';
...
const handsLightColor = Color(0xFF222225);
const handsDarkColorColor = Color(0xFFE4E9F2);
